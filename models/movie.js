...
var movie = new Schema({
    movie_title:            { type: String, required: true, default: '-' },
    movie_title_normalized: { type: String, required: true, default: '-' },
    movie_id_normalized:    { type: String, required: true, default: '-' },
    movie_original_title:   { type: String, required: false },
    movie_runtime:          { type: String, required: false },
    movie_plot:             { type: String, required: true, default: '-' },
    movie_year:             { type: Number, required: true, default: 0 },
    movie_release_date:     { type: String, required: true, default: '-' },
    movie_country:          { type: String, required: false },
    movie_rating_fa:        { type: String, required: true, default: '-' },
    movie_rating_imdb:      { type: String, required: true, default: '-' },
    movie_rating_score:     { type: String, required: true, default: '-' },
